...
```{r}
accessData <- read.csv("sapatos_ko.csv")
head(accessData)
...
png("VAR_TOTAL.png")
dev.off()
knitr::include_graphics("/cloud/project/rWorksheet#4b/VAR_TOTAL.png")
...
png("bwVAR.png")
dev.off()
knitr::include_graphics("/cloud/project/rWorksheet#4b/bwVAR.png")
